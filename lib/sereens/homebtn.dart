...
import 'package:bmi_calculator/sereens/note_screens/note_screens.dart';
                    ...
                    onTap: () {
                      setState(() {
                        Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (context) => Bmidesignscernce(),
                          ),
                        );
                      });
                    },
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                image: AssetImage(
                                  "assets/image/jpg/bmicalculator.jpg",
                                ),
                                fit: BoxFit.cover,
                              ),
                            ),
                ...
                Padding(
                  ...
                  child: InkWell(
                    onTap: () {
                      setState(() {
                        Navigator.of(context).push(
                          MaterialPageRoute(builder: (context) => DailyCare()),
                        );
                      });
                    },
                    child: Container(
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                image: AssetImage(
                                  "assets/image/png/nijerjotnno.png",
                                ),
                                fit: BoxFit.fitWidth,
                              ),
                            ),
                      ...
                      child: InkWell(
                        onTap: () {
                          setState(() {
                            Navigator.of(context).push(
                              MaterialPageRoute(
                                builder: (context) => DoctorHomeScreens(),
                              ),
                            );
                          });
                        },
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                    image: AssetImage(
                                      "assets/image/jpg/doctor_home.jpg",
                                    ),
                                    fit: BoxFit.cover,
                                  ),
                                ),
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                    image: AssetImage(
                                      "assets/image/jpg/potidiner_note.jpg",
                                    ),
                                    fit: BoxFit.fitWidth,
                                  ),
                                ),
