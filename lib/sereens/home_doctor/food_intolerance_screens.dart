      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(
                '''নির্দিষ্ট কিছু খাবারে হজমে সমস্যা হওয়া এবং সেগুলো খাওয়ার পর শরীরে বিরূপ প্রতিক্রিয়া দেখা দেওয়ার ঘটনাকে খাদ্যে অসহনীয়তা বলা হয়।
...
অনেকেই খাদ্যে অসহনীয়তায় ভুগছেন বলে মনে করলেও দেখা যায় যে তাদের লক্ষণগুলোর পেছনে আসলে ভিন্ন কোনো কারণ দায়ী।''',
                style: TextStyle(fontWeight: FontWeight.w500),
              ),
              SizedBox(height: 8),
              Text(
                "খাদ্যে অসহনীয়তার লক্ষণ",
                style: TextStyle(
                  fontSize: 25,
              ...
              Text(
                '''সাধারণত যেসব খাবারে রোগীর অসহনীয়তা রয়েছে সেগুলো খাওয়ার কয়েক ঘন্টা পর কিছু লক্ষণ দেখা দেয়। তবে এই সাধারণ লক্ষণগুলো যে কেবল খাদ্যে অসহনীয়তার জন্যই নির্দিষ্ট—তা নয়। বিভিন্ন ধরনের রোগেও এই জাতীয় লক্ষণগুলো দেখা যায়।
...
নির্দিষ্ট কোনো খাবার সহ্য না হলে রোগীর মধ্যে সাধারণত নিচের লক্ষণগুলো দেখা দেয়—''',
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: 20),
                    Text(
                      "ত্বকে ফুসকুড়ি বা র‍্যাশ দেখা দেওয়া",
                      style: TextStyle(
                        color: Allcolor.redcolor,
                        fontSize: 23,
                        fontWeight: FontWeight.w600,
              ...
              SizedBox(height: 8),
              Text(
                "খাদ্যে অসহনীয়তার মতো লক্ষণ দেখা দিতে পারে যেসব রোগে----",
                style: TextStyle(
                  fontSize: 23,
                  color: Allcolor.pinkcolor,
                  fontWeight: FontWeight.bold,
              ...
              Text(
                '''নিয়মিতভাবে নিচের চারটি লক্ষণ দেখা দিলে এবং লক্ষণগুলোর কারণ সম্পর্কে নিশ্চিত না হতে পারলে ডাক্তারের পরামর্শ নিতে হবে—
...
পরিপাকতন্ত্র একটি স্পর্শকাতর অঙ্গ। তাই অসুস্থ হলে অথবা মানসিক চাপের মধ্যে থাকলে প্রায়ই পেটের বিভিন্ন সমস্যা দেখা দিতে পারে।''',
                style: TextStyle(fontSize: 18),
              ),

              Text(
                "খাদ্যে অসহনীয়তার কারণ--",
                style: TextStyle(
                  fontSize: 25,
                  color: Allcolor.pinkcolor,
                  fontWeight: FontWeight.bold,
              ...
              SizedBox(height: 8),
              Text(
                '''একজন মানুষ ঠিক কী কারণে নির্দিষ্ট কিছু খাবার সহ্য করতে পারে না সেটি সবসময় সহজে বোঝা যায় না। কিছু কিছু ক্ষেত্রে খাবার ও লক্ষণের সম্পর্ক থেকে অসহনীয়তার কারণ সম্পর্কে ধারণা পাওয়া যায়।
...
হিস্টামিন নামক একটি রাসায়নিক। এটি মাশরুম, প্রক্রিয়াজাত করা খাবার ও অ্যালকোহলযুক্ত পানীয়তে থাকতে পারে''',
                style: TextStyle(fontSize: 18),
              ),
              SizedBox(height: 8),
              Text(
                '''খাদ্যে অসহনীয়তা শনাক্ত করার উপায়--''',
                style: TextStyle(fontSize: 23, color: Allcolor.pinkcolor),
              ),
              SizedBox(height: 8),
              Text(
                '''নির্দিষ্ট কোনো খাবারে অসহনীয়তা আছে কি না সেটি নির্ণয়ের সবচেয়ে ভালো উপায় হলো—
...
এই পদ্ধতি চলাকালে শরীরে সব পুষ্টি উপাদানের প্রাপ্তি নিশ্চিত করতে একজন পুষ্টিবিদ বা ডায়েটিশিয়ান এর পরামর্শ নিন।''',
              ...
              Container(
                ...
                child: Center(
                  child: Padding(
                    ...
                    child: Text(
                      '''বিশেষ দ্রষ্টব্য: শিশুদের ক্ষেত্রে ডাক্তার অথবা ডায়েটিশিয়ান এর পরামর্শ ছাড়া কখনও কোনো নির্দিষ্ট খাবার খাওয়ানো বন্ধ করবেন না।''',
                      style: TextStyle(color: Allcolor.redcolor, fontSize: 20),
                    ),
                  ),
                ),
              ),
              SizedBox(height: 9),
              Text(
                "খাদ্যে অসহনীয়তার ঘরোয়া চিকিৎসা--",
                style: TextStyle(
                  fontSize: 23,
                  color: Allcolor.pinkcolor,
                  fontWeight: FontWeight.bold,
              ...
              SizedBox(height: 9),
              Text(
                '''কোনো নির্দিষ্ট খাবারে অসহনীয়তার ব্যাপারে নিশ্চিত হলে এটি নিয়ন্ত্রণের একমাত্র উপায় হলো কিছুদিনের জন্য সেই খাবার খাওয়া বন্ধ করে দেওয়া। এরপর একটু একটু করে খাবারটি আবারও ডায়েটে যোগ করতে হবে।
...
যেমন, অনেকে শিশুর খাবারের তালিকা থেকে গরুর দুধ বাদ দিয়ে ফেলেন। গরুর দুধ ক্যালসিয়াম, ভিটামিন ডি ও প্রোটিনের খুব ভালো উৎস। তাই শিশুর শরীরে গরুর দুধ সহ্য না হলে ডাক্তারের পরামর্শ নিয়ে বিকল্প উপায়ে প্রয়োজনীয় পুষ্টি উপাদান প্রাপ্তি নিশ্চিত করার পরেই কেবল তা শিশুর খাবারের তালিকা থেকে বাদ দেওয়া যেতে পারে''',
                style: TextStyle(fontSize: 18),
              ),
              SizedBox(height: 10),
              Container(
                ...
                child: Center(
                  child: Text(
                    '''যখন ডাক্তারের পরামর্শ নেওয়া জরুরি
